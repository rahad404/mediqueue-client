...
import {
   BookOpen, Loader2, CalendarX, AlertTriangle,
   XCircle, CheckCircle2, Clock, User
} from "lucide-react"
   ...
   const handleCancel = async () => {
      ...
      try {
         ...
         if (res.ok) {
            ...
            setBookings(prev =>
               prev.map(b =>
                  b._id === cancelBooking._id ? { ...b, bookingStatus: "cancelled" } : b
               )
            )
            setCancelOpen(false)
         ...
         <div className="mx-auto max-w-6xl space-y-6">
            ...
            {bookings.length === 0 ? (
               <div className="flex flex-col items-center justify-center py-24 text-center bg-background rounded-xl border border-dashed">
                  ...
                  <Button className="mt-5 gap-2" onClick={() => window.location.href = "/tutors"}>
            ...
            {bookings.length > 0 && (
               <div className="flex items-center justify-between text-sm text-muted-foreground px-1">
                  ...
                  <span>
                     {bookings.filter(b => b.bookingStatus?.toLowerCase() !== "cancelled").length} active
                  </span>
               </div>
            )}
         </div>
            ...
            <AlertDialogContent>
               <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                     ...
                     . The slot will be released back to the tutor. This cannot be undone.
                  </AlertDialogDescription>
               </AlertDialogHeader>
               <AlertDialogFooter>
