    ...
    try {
      ...
      if (tokenData) {
        ...
        if (response.ok) {
          ...
          toast.error(bookingResponseData.message || "Booking failed. Please try again.");
        }
      }
    } catch (err) {
          ...
          <Card className="border-slate-200/60 dark:border-zinc-800/80 shadow-none w-full">
            <CardContent className="p-4 space-y-3.5">
              <div className="flex justify-between items-center text-sm">
                ...
                <span className="font-bold text-lg text-slate-900 dark:text-zinc-50">
                  ৳{tutor.hourlyFee}/hr
                </span>
              </div>
              <div className="flex justify-between items-center text-sm">
        ...
        <div className="md:col-span-2 w-full space-y-6 min-w-0">
          ...
          {!isFullyBooked && isBookingClosed && (
            <div className="flex items-center gap-2 p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-700 dark:text-amber-400 text-sm font-medium w-full">
              ...
              <span>
                Booking is over on{" "}
                {parsedsessionStartDate.toLocaleDateString("en-US", {
                  dateStyle: "long",
                })}
                .
              </span>
              ...
              <DialogTrigger asChild>
                <div className="w-full sm:w-auto">
                  <Button
                    ...
                    onClick={(e) => {
                      if (bookingBlocked) e.preventDefault();
                    }}
                  >
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <Input
                        value={id}
                        disabled
                        className="bg-slate-50 dark:bg-zinc-900 text-xs font-mono"
                      />
                    </div>
